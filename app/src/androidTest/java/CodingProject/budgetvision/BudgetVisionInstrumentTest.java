...
public class BudgetVisionInstrumentTest {
//
//    //activity scenerio rule for main activity.
//    @Rule
...
//    //activity scenerio rule for main activity.
//    @Rule
//    public ActivityScenarioRule<DeleteSubcategoryPopup> dspActivityScenarioRule = new ActivityScenarioRule<>(DeleteSubcategoryPopup.class);
//
//    @Test
//    public void test_01() {
//
...
//
//    /**
//     * Testing the main activity getDailyBudget and getTotalIncome methods for the main user.
//     * Also testing the add new user and remove user methods. Each added users getDailyBudget and getTotalIncome methods tested.
//     * the formula of the daily budget is monthly expenses / 30.
//     * the formula of the total income is (initial income of user - monthly expenses)
//     */
//    @Test
...
//                UsersBudgetClass Nilushanth = activity.getMainUser("#Default");
//                Nilushanth.addUserCategory("Food");
//                Nilushanth.addUserSubcategory("Groceries", 360);
//                Nilushanth.addUserSubcategory("Pet food", 123);
//                Nilushanth.addUserSubcategory("Lunch", 270);
//
//                double monthlyExpenses = 360 + 123 + 270;
//                String expectedDailyBudget = "$ " + String.format("%.2f", monthlyExpenses / 30.0);
//                activity.updateDailyBudget(); //update the views in the activity.
//                assertEquals(expectedDailyBudget, activity.getDailyBudget());
//
//                Nilushanth.increaseUserInitialIncome(10000); //the user initial income is 10,000.
//                String expectedTotalIncome = "$ " + String.format("%,.2f", 10000 - monthlyExpenses);
//                activity.updateTotalIncome(); //update the views in the activity.
//                assertEquals(expectedTotalIncome, activity.getTotalIncome());
//
//                Nilushanth.addNewUsers("Bob");//adding first new user, Bob.
//                Nilushanth.addNewUsers("Jim");//adding second new user, Jim.
//
//                UsersBudgetClass Bob = Nilushanth.getUserObjectOfName("Bob"); //bob UsersBudgetClass object.
//
//                /*
//                 * Giving Bob Commute expenses.
//                 */
//                Bob.addUserCategory("Commute");
//                Bob.addUserSubcategory("Bus", 350);
//                Bob.addUserSubcategory("Taxi", 114);
//                Bob.addUserSubcategory("Uber", 263);
//
//                monthlyExpenses = 350 + 114 + 263;
//                expectedDailyBudget = "$ " + String.format("%.2f", monthlyExpenses / 30.0);
//                assertEquals(expectedDailyBudget, Bob.getCurrencySymbol() + " " + Bob.userDailyBudget());
//
//                /*
//                 * Giving Bob Lifestyle expenses.
//                 */
//                Bob.addUserCategory("Lifestyle");
//                Bob.addUserSubcategory("Gym", 250);
//                Bob.addUserSubcategory("Dentist", 824);
//                Bob.addUserSubcategory("Doctor", 433);
//
//                monthlyExpenses += 250 + 824 + 433;
//                expectedDailyBudget = "$ " + String.format("%.2f", monthlyExpenses / 30.0);
//                assertEquals(expectedDailyBudget, Bob.getCurrencySymbol() + " " + Bob.userDailyBudget());
//
//                /*
//                 * Giving Bob Recreation expenses.
//                 */
//                Bob.addUserCategory("Recreation");
//                Bob.addUserSubcategory("Netflix", 50);
//                Bob.addUserSubcategory("Hulu", 24);
//                Bob.addUserSubcategory("Disney plus", 133);
//
//                monthlyExpenses += 50 + 24 + 133;
//                expectedDailyBudget = "$ " + String.format("%.2f", monthlyExpenses / 30.0);
//                assertEquals(expectedDailyBudget, Bob.getCurrencySymbol() + " " + Bob.userDailyBudget());
//
//                /*
//                 * Giving Bob Housing expenses.
//                 */
//                Bob.addUserCategory("Housing");
//                Bob.addUserSubcategory("Rent", 2324);
//                Bob.addUserSubcategory("Internet", 44.43);
//                Bob.addUserSubcategory("TV", 24.42);
//                Bob.addUserSubcategory("Electricity", 120.32);
//
//                monthlyExpenses += 2324 + 44.43 + 24.42 + 120.32;
//                expectedDailyBudget = "$ " + String.format("%.2f", monthlyExpenses / 30.0);
//                assertEquals(expectedDailyBudget, Bob.getCurrencySymbol() + " " + Bob.userDailyBudget());
//
//                /*
//                 * Testing Bobs getStatus() method.
//                 */
//                String expectedStatus = "Food:\n" +
//                        "\n" +
//                        "\n" +
...
//                        "Disney plus          $ 133.00";
//
//                assertEquals(expectedStatus, Bob.getUserStatus());
//
//                HomeFragment homeFragment = (HomeFragment) activity.getHomeFragment();
//
//                String category = ""; //string variable to hold the category from the home fragment.
//
//                //testing the category displayed is food  when food card is clicked.
//                CardView foodCard = (CardView) activity.findViewById(R.id.foodCard);
//                foodCard.performClick();
//
//                category = homeFragment.getCategory();
//                assertEquals("food", category);
//
//                //testing the category displayed is lifestyle  when lifestyle card is clicked.
//                CardView lifestyleCard = (CardView) activity.findViewById(R.id.lifestyleCard);
//                lifestyleCard.performClick();
//
//                category = homeFragment.getCategory();
//                assertEquals("lifestyle", category);
//
//                //testing the category displayed is recreation  when recreation card is clicked.
//                CardView recreationCard = (CardView) activity.findViewById(R.id.recreationCard);
//                recreationCard.performClick();
//
//                category = homeFragment.getCategory();
//                assertEquals("recreation", category);
//
//                //testing the category displayed is commute when commute card is clicked.
//                CardView commuteCard = (CardView) activity.findViewById(R.id.commuteCard);
//                commuteCard.performClick();
//
//                category = homeFragment.getCategory();
//                assertEquals("commute", category);
//
//                //testing the category displayed is housing when housing card is clicked.
//                CardView housingCard = (CardView) activity.findViewById(R.id.housingCard);
//                housingCard.performClick();
//
//                category = homeFragment.getCategory();
//                assertEquals("housing", category);
//
//                homeFragment.popUpWindowRemove();
//
//                MoneyFragment moneyFragment  = (MoneyFragment) activity.getMoneyFragment();
//                assertNotNull(moneyFragment);
//
//                SettingsFragment settingsFragment = (SettingsFragment) activity.getSettingsFragment();
...
//
    ...
    public void useAppContext() {
        ...
        assertEquals("CodingProject.budgetvision", appContext.getPackageName());
    }
}